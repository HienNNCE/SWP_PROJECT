...
/**
 * LoginServlet handles user login and logout functionalities.
 * It processes HTTP GET requests for logout and HTTP POST requests for login.
 * It interacts with the UserDAO to authenticate users against the database.
 * @author 
 */
public class LoginServlet extends HttpServlet {
   ...
   /**
     ...
     * This method is primarily used for handling logout requests.
     * If the "action" parameter is "logout", it invalidates the user's session.
     *
     * @param request servlet request
     * @param response servlet response
     * @throws ServletException if a servlet-specific error occurs
     ...
     * This method is invoked when a user submits the login form.
     * It attempts to authenticate the user using the provided username/email and password.
     *
     * @param request servlet request
     * @param response servlet response
     * @throws ServletException if a servlet-specific error occurs
