...
@WebServlet(name = "StaffBlogServlet", urlPatterns = {
    "/staff/blog", "/staff/blog/create", "/staff/blog/edit", "/staff/blog/delete", "/staff/blog/detail"
})
@MultipartConfig
public class StaffBlogServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "/staff/blog/create":
                showCreateForm(request, response);
                break;
            case "/staff/blog/edit":
                showEditForm(request, response);
                break;
            case "/staff/blog/delete":
                deleteBlog(request, response);
                break;
            case "/staff/blog/detail":
    ...
    private void showCreateForm(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("/staff/blog/create-form.jsp").forward(request, response);
    }
    ...
    private void handleCreate(HttpServletRequest request, HttpServletResponse response)
        ...
        blogDAO.create(blog);
        response.sendRedirect(request.getContextPath() + "/staff/blog?msg=created");
    }
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/staff/blog/edit-form.jsp").forward(request, response);
    }
    ...
    private void handleEdit(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/staff/blog?msg=updated");
    }
    ...
    private void deleteBlog(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(request.getParameter("id"));
        blogDAO.delete(id);
        response.sendRedirect(request.getContextPath() + "/staff/blog?msg=deleted");
    }
