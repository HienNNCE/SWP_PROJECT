...
@WebServlet(name = "StaffPartServlet", urlPatterns = {
    "/staff/part", "/staff/part/create", "/staff/part/edit", "/staff/part/delete", "/staff/part/detail"
})
@MultipartConfig
public class StaffPartServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "/staff/part/create":
                showAddForm(request, response);
                break;
            case "/staff/part/edit":
                showEditForm(request, response);
                break;
            case "/staff/part/delete":
                deletePart(request, response);
                break;
            case "/staff/part/detail":
    ...
    private void listParts(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/staff/part/parts-list.jsp").forward(request, response);
    }
    ...
    private void handleAdd(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/staff/part?msg=created");
    }
    ...
    private void handleEdit(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/staff/part?msg=updated");
    }
    ...
    private void deletePart(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/staff/part?msg=deleted");
    }
    ...
    private void showDetail(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("part", part);
        request.getRequestDispatcher("/staff/part/part-detail.jsp").forward(request, response);
    }
