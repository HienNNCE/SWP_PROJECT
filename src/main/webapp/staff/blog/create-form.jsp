    ...
    <body class="admin-panel">
        ...
        <div class="main-content">
            ...
            <div class="card p-4">
                ...
                <form action="${pageContext.request.contextPath}/staff/blog/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-4" style="display: flex; justify-content: center; gap: 16px;">
                        ...
                        <a href="${pageContext.request.contextPath}/staff/blog" class="btn btn-outline-dark px-4">
