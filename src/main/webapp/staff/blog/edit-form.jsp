    ...
    <body class="admin-panel">
        ...
        <div class="main-content">
            ...
            <div class="card p-4">
                ...
                <form action="${pageContext.request.contextPath}/staff/blog/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group text-center mt-4">
                        <div style="display: inline-flex; gap: 12px;">
                            ...
                            <a href="${pageContext.request.contextPath}/staff/blog/detail?id=${blog.id}" class="btn btn-info px-4">
                                <i class="fas fa-eye"></i> Back to Detail
                            </a>
                            <a href="${pageContext.request.contextPath}/staff/blog" class="btn btn-secondary px-4">
