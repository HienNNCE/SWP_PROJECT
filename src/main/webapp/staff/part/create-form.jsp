    ...
    <body class="admin-panel">
        ...
        <div class="main-content">
            ...
            <div class="card">
                ...
                <form action="${pageContext.request.contextPath}/staff/part/create" method="post" enctype="multipart/form-data">
                    ...
                    <c:if test="${errors.price != null}"><div class="error">${errors.price}</div></c:if>
                        ...
                        <div style="text-align:center; margin-top:15px;">
                            ...
                            <a href="${pageContext.request.contextPath}/staff/part" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
                    </div>
                </form>
            </div>
