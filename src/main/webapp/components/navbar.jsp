    ...
    <div class="container">
        <div class="main-header">
            ...
            <div class="right-section">
                <div class="header-actions">
                    <c:if test="${sessionScope.account != null}">
                        <a href="${pageContext.request.contextPath}/cart"
                           class="cart-icon" title="Shopping Cart">
                            ...
                            <span id="cart-total-price" class="cart-total">
                                $<fmt:formatNumber value="${totalPrice != null ? totalPrice : 0}" type="number" minFractionDigits="0"/>
                            </span>
                        </a>
                    </c:if>
                ...
                s
                <a href="${pageContext.request.contextPath}/login?action=login"class="login-btn">
                    <c:choose>
