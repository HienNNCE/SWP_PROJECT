                        ...
                        <div class="parts-grid">
                            <c:forEach var="part" items="${parts}">
                                <div class="part-card">
                                    ...
                                    <div class="part-card-footer card">
                                        ...
                                        <button type="button" part-id='${part.partId}' class="part-add-btn add_to_cart" <c:if test="${part.partStock <= 0}">disabled</c:if>>Add to Cart</button>
                                        </div>
                                    </div>
                            </c:forEach>
