        ...
        <div class="content">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <h1 class="page-title">Cars Appointment Management</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive" style="max-width: 100%; overflow-x: auto;">
                            <table class="table table-bordered table-hover car-table" style="min-width: 1500px;">
                                ...
                                <tbody>
                                    <c:if test="${empty carAppointments}">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    <button 
                                                        ...
                                                        data-id="${car.getCarAppointmentId()}" 
    ...
    <script>
        ...
        function confirmDelete(caId) {
            if (confirm("Bạn có chắc chắn muốn xóa xe này không? Hành động này không thể hoàn tác.")) {
                window.location.href = "${pageContext.request.contextPath}/admin/carAppointment?action=delete&id=" + caId;
            }
        }
