            ...
            <div class="container">
                <div class="order-card">
                        ...
                        <c:forEach var="item" items="${orderDetail}">
                            <div class="order-item">
                                <div class="item-image">
                                    <!-- Nếu có ảnh part, thay src cho phù hợp, nếu không có thì để ảnh mặc định -->
                                    <img src="${pageContext.request.contextPath}/asset/img/parts/${item.getPart().getPartImg()}" alt="Part ${item.partId}">
                                </div>
                                <div class="item-details">
                                    <span class="item-name">${item.getPart().getPartName()}</span>
                                    <p class="item-brand">Quantity: ${item.quantity}</p>
                                    <p class="item-price">$<fmt:formatNumber value="${item.price}" pattern="#,##0.00"/></p>
                                    <div class="item-meta">
                        ...
                        <div class="order-summary">
                            <div class="summary-row">
                                ...
                                <span class="summary-value">
                                    $<fmt:formatNumber value="${order.getOrderPrice()}" pattern="#,##0.00"/>
                                </span>
                            </div>
                    ...
                    <div style="margin-top: 30px; text-align: center;">
                        <a href="${pageContext.request.contextPath}/admin/OrderManagementServlet" class="btn btn-outline" style="margin-right: 15px;"><i class="fas fa-arrow-left"></i> Back to Order History</a>
                    </div>
                </div>
            </div>
        </section>
