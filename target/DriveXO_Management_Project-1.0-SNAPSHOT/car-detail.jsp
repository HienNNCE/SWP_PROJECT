...
<html>
    ...
    <body>
        ...
        <a href="${pageContext.request.contextPath}/car/list" class="back-button">
            ...
            <div class="container">
                ...
                <div class="similar-cars">
                    ...
                    <div class="similar-cars-grid">
                        <!-- Placeholder for dynamic similar cars -->
                        <c:forEach begin="1" end="4">
                            <div class="car-card">
                                <div class="card-image">
                                    <span class="card-tag">New</span>
                                    <img src="${pageContext.request.contextPath}/asset/img/cars/default-car.png" alt="Similar Car">
                                ...
                                <div class="card-content">
                                    <div class="card-brand">BMW</div>
                                    <h3 class="card-name">2022 X5 3.0i</h3>
                                    <div class="card-price">$52,995</div>
